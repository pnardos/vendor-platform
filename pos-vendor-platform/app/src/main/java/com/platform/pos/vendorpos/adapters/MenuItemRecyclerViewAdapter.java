...
public class MenuItemRecyclerViewAdapter extends RecyclerView.Adapter<MenuItemRecyclerViewAdapter.ViewHolder> {
  ...
  public MenuItemRecyclerViewAdapter(Context context, ArrayList<MenuItemData> menuItemDatas) {
    this.menuItemDatas = menuItemDatas;
    this.context = context;
  }

  @Override
  public MenuItemRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View itemView = LayoutInflater.from(context).inflate(R.layout.menu_card_item, parent, false);
    return new MenuItemRecyclerViewAdapter.ViewHolder(itemView);
  }

  @Override
  public void onBindViewHolder(MenuItemRecyclerViewAdapter.ViewHolder holder, int position) {
